...
export const sampleBooks = [
  {
    ...
    available_copies: 15,
    description:
      "A profound spiritual manifesto that shows how transcending ego-based consciousness is essential to personal happiness and the key to ending conflict and suffering.",
    coverColor: "#F57C00",
    coverUrl: "https://m.media-amazon.com/images/I/71EFrY9e--L._SL1500_.jpg",
